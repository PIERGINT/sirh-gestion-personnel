...
protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	//C) Erreur côté client si paramètres non renseignés.
		if (matriculeParam==null || titreParam==null || nomParam==null || prenomParam==null) {
			...
			if (matriculeParam==null){resp.getWriter().write("<li>Matricule</li>");}
			if (titreParam==null){resp.getWriter().write("<li>Titre</li>");}
			if (nomParam==null){resp.getWriter().write("<li>Nom</li>");}
			if (prenomParam==null){resp.getWriter().write("<li>Prenom</li>");}
